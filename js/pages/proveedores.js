...
(() => {
    fetch(window.SERVICIOURL+"/proveedores.php")
        ...
        .then((data) => {
            ...
            data.map((proveedor) => {
                ...
                let fila = "<tr><td>" + proveedor.idproveedor + "</td><td>" + proveedor.nombreempresa
                        + "</td><td>" + proveedor.nombrecontacto + "</td><td>" + proveedor.cargocontacto 
                        + "</td><td>" + proveedor.ciudad + "</td><td>" + proveedor.pais 
                        + "</td></tr>"
    
                document.getElementById("tbody-proveedor").innerHTML += fila
